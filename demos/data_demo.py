...
"""Use Viewer for getting data using a map"""
dtcc.data.start_map_viewer(parameters=parameters)

"""Or uncomment the code below to get data by applying the coordinates manually"""
